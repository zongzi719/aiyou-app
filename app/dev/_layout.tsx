...
export default function DevRootLayout() {
  ...
  return (
    <div style={{ display: 'flex', minHeight: '100vh', background: '#0a0a0a', color: '#e5e5e5', fontFamily: '-apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, sans-serif', fontSize: 14 }}>
      <aside style={{ width: 224, flexShrink: 0, borderRight: '1px solid #262626', background: '#171717', display: 'flex', flexDirection: 'column' }}>
        <div style={{ padding: '20px 16px', borderBottom: '1px solid #262626' }}>
          <h1 style={{ fontSize: 11, fontWeight: 700, letterSpacing: '0.1em', color: '#a3a3a3', textTransform: 'uppercase', margin: 0 }}>Developer Tools</h1>
        </div>
            ...
            return (
              <button
                ...
                style={{
                  ...
                  gap: 8, padding: '8px 12px', borderRadius: 6, marginBottom: 2,
        ...
        <div style={{ padding: '12px 16px', borderTop: '1px solid #262626' }}>
          <button
            onClick={() => router.push('/')}
            style={{ fontSize: 12, color: '#525252', background: 'none', border: 'none', cursor: 'pointer', padding: 0 }}
          >
            ← 返回 APP
          </button>
        </div>

          ...
          <View className="flex-1">
            ...
            {hasMessages ? (
              ...
              <View
                ...
                style={{ paddingBottom: insets.bottom + 130 }}>
                <CardScroller className="px-global pb-4">
                  <SuggestionCard
                    title="Make a recipe"
                    description="Find the best recipes"
                    icon="Cookie"
                  />
                  <SuggestionCard
...
const SuggestionCard = (props: any) => {
  return (
    <TouchableOpacity
      activeOpacity={0.8}
      className="flex w-[270px] flex-row items-center rounded-3xl border border-border bg-secondary p-4">
      <Icon name={props.icon} size={20} className="h-14 w-14 rounded-2xl bg-background" />

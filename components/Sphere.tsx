...
export const Sphere = () => {
  ...
  return (
    <View
      ...
      style={{ paddingBottom: insets.bottom + 140, paddingTop: insets.top + 0 }}>
      <AnimatedView
        animation="scaleIn"
        duration={200}
        ...
        <TouchableOpacity
          ...
          <View
            ...
            className="relative z-[9999] h-[140px] w-[140px] items-center justify-center rounded-full bg-secondary">
            <LottieView
              autoPlay
              style={{
                width: 250,

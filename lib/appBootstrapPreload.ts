...
const LOCAL_IMAGE_MODULES = [
  ...
  require('@/assets/images/backgrounds/model-init-home-bg.jpg'),
  require('@/assets/images/backgrounds/model-init-interview-bg.jpg'),
  require('@/assets/images/backgrounds/model-init-voice-bg.jpg'),
  require('@/assets/images/backgrounds/model-init-image-bg.jpg'),
  require('@/assets/images/backgrounds/model-init-avatar-loading-bg.jpg'),
  require('@/assets/images/backgrounds/model-init-avatar-done-bg.jpg'),
